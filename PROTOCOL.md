...
In short: enclaves in the cloud don't require stronger trust assumptions than you're already accepting when you want to access web data - so avoiding them wouldn't make your contract any more 'trustless'.
