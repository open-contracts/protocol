...
In short: enclaves in the cloud don't require any more trust than the web does to begin with - so avoiding them wouldn't make an Open Contract significantly more 'trustless'.
